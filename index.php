...
if ($text == "") {
    ...
    $response .= "1. My Electricity meter \n";
    $response .= "2. My Balance unit";

} else if ($text == "1") {
    // Business logic for first level response
    $response = "CON Choose  information you want to view \n";
    $response .= "1. Meter number \n";
    ...
    $accountNumber  = "22393939";

    // This is a terminal request. Note how we start the response with END
    $response = "END Your meter number is ".$accountNumber;
